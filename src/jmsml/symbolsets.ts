  ...
  },
  {
    ...
    sectorTwoModifiers: [
      ...
      },
      {
        ...
        graphic: "02132.svg",
        remarks:
          "1000km to 3500km. Typically used in reference to surface-to-air missiles.",
        category: "Missile Range",
      },
      {
        digits: "14",
        ...
        graphic: "02142.svg",
        remarks:
          "1000km to 3500km. Typically used in reference to ballistic missiles.",
        category: "Missile Range",
      },
      {
        digits: "15",
  ...
  },
  {
    ...
    entities: [
      ...
      },
      {
        ...
        remarks:
          "This symbol shall not be displayed on a C2 system but may be displayed for training or hierarchical explanation purposes.",
        entityTypes: [
          {
            digits: "01",
            label: "Space Vehicle",
        ...
        entityTypes: [
          {
            ...
            entitySubTypes: [
              ...
              },
              {
                ...
                remarks:
                  "DISA changed this to full frame as a result of a telecon discussion with the Army, but not reflected that way in the final PDF.",
                icon: "FULL_FRAME",
              },
              {
                digits: "03",
  ...
  },
  {
    ...
    entities: [
      ...
      },
      {
        ...
        id: "UTILITY_VEHICLES",
        remarks:
          "No icon is associated with this entity. It is for hierarchical purposes only.",
        icon: "NA",
        geometryType: "NA",
        entityTypes: [
          {
      ...
      },
      {
        ...
        entityTypes: [
          ...
          },
          {
            ...
            id: "LINE_OF_CONTACT",
            remarks:
              "Line of Contact is a doctrinal term and concept for opposing and parallel Forward Lines of Own Troops.  It is not a symbol in its own right.",
            icon: "NA",
            geometryType: "NA",
            entitySubTypes: [],
          },
      ...
      },
      {
        ...
        entityTypes: [
          ...
          },
          {
            digits: "68",
            label:
              "Remote Multi-Mission Vehicle Mine Warfare Unmanned Underwater",
          ...
          },
          {
            digits: "88",
            label:
              "Bottom Return/Non-Mine Like Bottom Object (NOMBO)/Installation Manmade",
  ...
  },
  {
    ...
    entities: [
      ...
      },
      {
        ...
        remarks:
          "The diameter of the icon shall be 1L. This icon shall be used with a friend standard identity only.",
        icon: "FULL_OCTAGON",
        entityTypes: [],
      },
      {
    ...
    sectorOneModifiers: [
      ...
      },
      {
        digits: "21",
        label:
          "Ballistic Missile Defense, Long-Range Surveillance and Track (LRST)",
        id: "LRST_MOD",
        graphic: "30211.svg",
        category: "Mission Area",
      },
      ...
      },
      {
        ...
        entityTypes: [
          ...
          },
          {
            digits: "02",
            label:
              "Autonomous Underwater Vehicle (AUV)/ Underwater Vehicle (UUV)",
            id: "AUV_UUV_CIV",
  ...
  },
  {
    ...
    entities: [
      ...
      },
      {
        ...
        entityTypes: [
          ...
          },
          {
            ...
            id: "FRONTAL_SYSTEMS",
            remarks:
              "For special lines that are not symmetrical, such as Fronts, the sequence of anchor points determines the proper alignment of the line.",
            icon: "NA",
            geometryType: "NA",
            entitySubTypes: [
              {
          ...
          },
          {
            ...
            remarks:
              "Each symbols within the pressure tendency group is static, but only one can be applied to a particular station plot, dependent upon the pressure tendency at that location. As such, the group of symbols is dynamic.",
            icon: "NA",
            geometryType: "NA",
            entitySubTypes: [
              {
      ...
      },
      {
        ...
        id: "TURBULENCE",
        remarks:
          "USAF turbulence forecasts are based on Category II type aircraft.",
        icon: "NA",
        geometryType: "NA",
        entityTypes: [
          {
